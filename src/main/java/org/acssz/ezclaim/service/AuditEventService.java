...
public class AuditEventService {
    ...
    public Page<AuditEvent> search(String entityType,
                                   String entityId,
                                   String action,
                                   Instant from,
                                   Instant to,
        ...
        if (entityType != null && !entityType.isBlank()) criteria.add(Criteria.where("entityType").is(entityType));
        if (entityId != null && !entityId.isBlank()) criteria.add(Criteria.where("entityId").is(entityId));
