...
public class ClaimRequest {
    @NotBlank
    @Schema(description = "Short title of the claim", example = "Conference Ticket")
    ...
    @NotNull
    @Positive
    @Schema(description = "Amount to reimburse", example = "199.99")
    ...
    @NotNull
    @Schema(description = "Payout destination info")
    ...
    @NotNull
    @Schema(description = "When the expense occurred (ISO-8601)", example = "2025-08-12T09:30:00Z")
